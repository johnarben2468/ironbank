...
<div class="row">
    ...
    @endif
            ...
            @foreach($staffs as $staff)
                ...
                <tr >
                    ...
                    <td>{{ $staff->email }}</td>
                    <td>
                        <a href="/staff/staffs/edit/{{$staff->id}}">
    ...
    <center><a href="/staff/staffs/add">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/staff/staffs/deactivate/{{$staff->id}}" class="btn btn-warning" id="confirm">Deactivate </a>
                </div>
            </div>
        </div>
    </div>              
    ...
    <div class="modal fade" id="{{ $modalName . '_' . $staff->id }}" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn " data-dismiss="modal">Cancel</button>
                    <a href="/staff/staffs/activate/{{$staff->id}}" class="btn btn-success" id="confirm">Activate </a>
                </div>
            </div>
        </div>
    </div>              
